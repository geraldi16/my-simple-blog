...
public class Frame4 extends JFrame {
	...
	public Frame4() {
		...
		setTitle("KutaRaya, 32 - 52");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(400, 10, 583, 700);
		...
		lblNewLabel.setIcon(new ImageIcon(Frame4.class.getResource("/gambar/Frame 4.jpg")));
		lblNewLabel.setBounds(10,33,340, 618);
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"","KR-32", "KR-33", "KR-34", "KR-35", "KR-36", "KR-37", "KR-38", "KR-39", "KR-40", "KR-41", "KR-42", "KR-43", "KR-44", "KR-45", "KR-46", "KR-47", "KR-48", "KR-49", "KR-50", "KR-51", "KR-52"}));
		comboBox.setBounds(489, 89, 63, 20);
		contentPane.add(comboBox);
		
		JLabel labelKeterangan = new JLabel("KutaRaya, 32 - 52");
		labelKeterangan.setHorizontalAlignment(SwingConstants.CENTER);
		labelKeterangan.setFont(new Font("Monospaced", Font.BOLD, 20));
		labelKeterangan.setBounds(10, 0, 340, 41);
		contentPane.add(labelKeterangan);
		
		JPanel panel = new JPanel();
		panel.setLayout(null);
		panel.setBorder(new LineBorder(new Color(0, 0, 0)));
		panel.setBounds(372, 141, 179, 158);
		...
		lblPilihanRumah.setBounds(371, 93, 90, 14);
		...
		btnNewButton.setBounds(377, 361, 176, 30);
		...
		btnNewButton_1.setBounds(378, 322, 173, 30);
