...
public class Frame5 extends JFrame {
	...
	public Frame5() {
		...
		lblNewLabel.setIcon(new ImageIcon(Frame5.class.getResource("/gambar/Frame 5.jpg")));
		lblNewLabel.setBounds(10,33,400, 600);
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"","KR-53", "KR-54", "KR-55", "KR-56", "KR-57", "KR-58", "KR-59", "KR-60", "KR-61", "KR-62", "KR-63", "KR-64", "KR-65", "KR-66", "KR-67", "KR-68", "KR-69", "KR-70", "KR-71", "KR-72"}));
		comboBox.setBounds(551, 87, 63, 20);
		contentPane.add(comboBox);
		
		JLabel labelKeterangan = new JLabel("KutaRaya, 53 - 72");
		labelKeterangan.setHorizontalAlignment(SwingConstants.CENTER);
		labelKeterangan.setFont(new Font("Monospaced", Font.BOLD, 20));
		labelKeterangan.setBounds(10, 0, 400, 41);
		contentPane.add(labelKeterangan);
		
		JPanel panel = new JPanel();
		panel.setLayout(null);
		panel.setBorder(new LineBorder(new Color(0, 0, 0)));
		panel.setBounds(434, 139, 179, 158);
		...
		lblPilihanRumah.setBounds(433, 91, 90, 14);
		...
		btnNewButton.setBounds(439, 359, 176, 30);
		...
		btnNewButton_1.setBounds(440, 320, 173, 30);
